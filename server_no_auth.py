# server_no_auth.py - Version without authentication for Cloud Run
import asyncio
import logging
import os
import requests
...
# Initialize FastMCP WITHOUT authentication
mcp = FastMCP(name="Pizza MCP Server on Cloud Run (No Auth)")
...
if __name__ == "__main__":
    logger.info(f"MCP server starting on port {PORT} (NO AUTH MODE)")
    mcp.run(
